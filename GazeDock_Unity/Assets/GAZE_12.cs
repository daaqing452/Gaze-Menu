...
namespace ViveSR {
    namespace anipal {
        namespace Eye {
            public class GAZE_12 : MonoBehaviour {
                ...
                private void Start() {
                    ...
                    filepath = "2-12-" + DateTime.Now.ToString("yyyyMMddhhmmss") + ".txt";
                    FileStream create = new FileStream("E:\\Gaze Dock\\rec\\" + filepath, FileMode.CreateNew);
                    create.Close();
                    gazeMenu = GameObject.Find("gaze_menu_12");
                ...
                string nextCount() {
                    ...
                    string mes = "";
                    if (count  % 12 == 0 || count == 0) randomInt = CreateRandom();
                    mes = menu[randomInt[count % 12] - 1];
                    count++;
                    return mes;
                }
