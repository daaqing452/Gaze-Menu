...
namespace ViveSR {
    namespace anipal {
        namespace Eye {
            public class gaze_6 : MonoBehaviour {
                ...
                private void Start() {
                    ...
                    filepath = "2-6-" + DateTime.Now.ToString("yyyyMMddhhmmss") + ".txt";
                    FileStream create = new FileStream("E:\\Gaze Dock\\rec\\" + filepath, FileMode.CreateNew);
                    create.Close();
                    gazeMenu = GameObject.Find("gaze_menu_6");
                ...
                private void FixedUpdate() {
                    ...
                    if (isStart && count == 0) {
                        ...
                        writer.WriteLine(mark + " " + time_recorder + " " + randomInt[(count - 1) % 6] + " " + GazeDirectionCombinedLocal.x + " " + GazeDirectionCombinedLocal.y
                ...
                // select  1- in; 0-out 1,true -in false; 0 true-out false;
                //dis_in  list  d2- abs (0,0,1)  d1- rel
                ...
                string nextCount() {
                    ...
                    string mes = "";
                    if (count % 6 == 0 || count == 0) randomInt = CreateRandom();
                    mes = menu[randomInt[count % 6] - 1];
                    count++;
                    return mes;
                }
