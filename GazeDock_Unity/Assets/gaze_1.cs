...
namespace ViveSR {
    namespace anipal {
        namespace Eye {
            public class gaze_1 : MonoBehaviour {
                ...
                private void Start() {
                    ...
                    filepath = "1-3-" + DateTime.Now.ToString("yyyyMMddhhmmss") + ".txt";
                ...
                void NewPos() {
                    ...
                    float r = Mathf.Tan(radius[angle] * Mathf.PI / 180);
                ...
                float[] creatRadius() {
                    ...
                    float[] Ra;
                    Ra = new float[361];
                    StreamReader str = new StreamReader(new FileStream("E:\\Gaze Dock\\angles02.txt", FileMode.Open, FileAccess.Read));
                    int i = 0;
                    while (true) {
                        string angle = str.ReadLine();
                        if (angle != null) {
                            Ra[360-i] = float.Parse(angle);
                            i++;
                        } else
                            break;
                    }
